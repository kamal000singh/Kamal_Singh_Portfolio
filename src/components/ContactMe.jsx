    ...
    <ContactComponents id="contact">
      <BoxLayout>
        <div className="outerBox">
          <a href="mailto:kamal000rawat@gmail.com" className="box1">
            GET IN TOUCH
          </a>
          <br />
          <a href="mailto:kamal000rawat@gmail.com" className="box2">
            GET IN TOUCH
          </a>
        </div>
      </BoxLayout>
      <SocialMedia>
        ...
        <Button onClick={() => window.open("https://github.com/kamal000singh")}>
        ...
        <Button
          onClick={() => window.open("https://www.facebook.com/maddyboykamal/")}
        >
