...
export const experience = [
  {
    ...
    languages: [],
    description:
      "I only worked for 3 month because It was contract based and I tested the PCB card there using some linux script.",
  },
  {
    ...
    description:
      "I was mantained their websites and I was designed and build store management applications with the help of HTML, CSS, JavaScript and PHP and use MySQL database to store data. In that application we can store details of import and export product and get the monthly,weekly and custom date report.",
  },
  {
    name: "RMSI Pvt. Ltd",
...

  {
    ...
    description:
      "I learnt about various Javascript frameworks like ReactJs, ExpressJS, NodeJS and MongoDB. And use the Socket.IO library for bi-directional and event-based communication.",
  },
  {
    name: "Minddeft Technologies",
